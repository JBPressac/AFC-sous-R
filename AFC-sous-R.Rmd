...
```{r read.table}
don <- read.table("AnaDo_JeuDonnees_TravailFemme.csv", header=TRUE, 
...
```{r plot(res)}
plot(res, cex = 0.7, cex.axis = 0.6, cex.lab = 0.8, title = "Représentation graphique", 
...
```{r barplot(res)}
barplot(res$eig[,1], main = "Histogramme des valeurs propres", 
        sub = "Représentations des femmes sur le travail féminin", 
        xlab = "Axes", ylab = "Pourcentage d'inertie", cex.axis = 0.8, 
        cex.names = 0.8, col ="orange", names.arg = 1:nrow(res$eig))
```
