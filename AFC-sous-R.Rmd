...
```{r wfemmes_pourcentage_en_ligne}
wfemmes_pourcentage_en_ligne <- wfemmes
wfemmes_pourcentage_en_ligne$Moyenne <- rowMeans(wfemmes_pourcentage_en_ligne)
wfemmes_pourcentage_en_ligne[nrow(wfemmes_pourcentage_en_ligne)+1, ] <- colSums(wfemmes_pourcentage_en_ligne)
row.names(wfemmes_pourcentage_en_ligne)[nrow(wfemmes_pourcentage_en_ligne)] <- "Total"
wfemmes_pourcentage_en_ligne
```
...
wfemmes_pourcentage_en_ligne <- rowPercents(wfemmes)
kable(wfemmes_pourcentage_en_ligne)
```

```{r wfemmes_pourcentage_en_colonne}
wfemmes_pourcentage_en_colonne <- colPercents(wfemmes)
kable(wfemmes_pourcentage_en_colonne)
```
...
# tableau_de_probabilite <- addmargins(wfemmes,FUN=list(Pourcentage=function(x) round(sum(x)/sum(wfemmes),2)))
