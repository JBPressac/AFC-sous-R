...
Dans le cadre d'un travail plus large sur l'analyse de données multidimensionnelles Spécificité de la séance : avec une AFC. Étudier les éventuelles liaisons entre les modalités de 2 variables qualitatives. Plus d'expérimentation qu'autre chose pour l'instant. Approfondissement qui a apporté davantage de questions. Travail sur des données de François Husson (Agrocampus Rennes) ou sur dse exemples que lui-même a repris.

# Les données

EXEMPLE DU CRÉDOC (jean-baptiste) sur 1724 femmes, Nicole Tabard du CREDOC, date de publication 1974.
Afficher le diaporama (slide 5 du PDF de Husson)
Sur un questionnaire de x questions au total, on cherche à étudier
l'articulation des réponses à deux questions.
Question (variable) 1 : Quelle est la famille idéale pour vous ?
Question (variable) 2 : Quelle activité convient le mieux à une mère de famille quand ses enfants 
vont à l’école ?
...
DÉFINIR LA LOCALISATION DU RÉPERTOIRE DE TRAVAIL (Montrer que l'on peut aussi utiliser la roue crantée dans RStudio)
...
STATISTIQUE DE BASE DU TABLEAU DE CONTINGENCE (Laurent)
...
RAPPEL DE CE QU'EST CETTE INDÉPENDANCE ET L'ÉCART À L'INDÉPENDANCE
...
...
L'intensité de la liaison (se mesure, notamment avec le Phi2) (Jean-Baptiste)
